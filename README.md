...
| `separator` | newline | Separator between rendered books. For comma-separated output, use `, ` and a template without a leading Markdown list marker. | No |
...
For comma-separated output, configure both the separator and a template without the default list marker:
